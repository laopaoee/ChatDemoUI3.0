...
import com.hyphenate.chatuidemo.utils.ShortcutUtil;
...
public class UserProfileActivity extends BaseActivity implements OnClickListener {
    ...
    public void addLinkToExp(View view) {
        ShortcutUtil.InstallShortcutUtil(this, tvNickName.getText().toString(),
                drawableToBitmap(headAvatar.getDrawable()), 1, tvUsername.getText().toString());
    }
