...
public class SettingsFragment extends Fragment implements OnClickListener {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        shareButton = (Button) getView().findViewById(R.id.share);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.share:
                ...
                // -1 表示是分享
                startActivityForResult(new Intent(getActivity(), ForwardMessageActivity.class).putExtra("forward_msg_id", "-1"),0);
                break;
            default:
                break;
        }
